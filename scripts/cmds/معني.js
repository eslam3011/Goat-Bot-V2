...
module.exports = {
	config: {
		...
		shortDescription: {
			...
			en: "رؤية معنى الايموجي "
		},
		longDescription: {
			vi: "Tìm nghĩa của emoji",
			en: "رؤية معاني الإيموجي"
		},
		category: "البحث",
		guide: {
			vi: "   {pn} <emoji>: Tìm nghĩa của emoji",
			en: "   معنى وايموجي يجلب معناه \n مثال \n معي 😍 "
		}
	},
	...
	langs: {
		...
		en: {
			missingEmoji: "⚠️ أدخل إيموجي ",
			meaningOfEmoji: "📌 معنى %1:\n\n📄 أول معنى: %2\n\n📑 المزيد من المعاني: %3%4\n\n📄 كود بسيط: %5\n\n©️ المصدر: %6\n\n  :",
			meaningOfWikipedia: "\n\n📝  تفاعل معي اجلب المعنة من ويكي  \"%1\" ",
			meanOfWikipedia: "📑 معنى \"%1\" في ويكيبيديا:\n%2",
			manyRequest: "⚠️البوت أرسل الكثير من الطلبات حاول لاحقا ",
			notHave: "لا يوجد معنة   "
		}
	},
