...
module.exports = {
	config: {
		...
		guide: {
			...
			en: "   قم بتحذير الاعضاء  اي عضو يتلقا ثلاث تحزيرات البوت يطردو \n\n مثال  \n رد علي  رسالة  شخص بي تحذير هوا ملل "
		}
	},
	...
	langs: {
		...
		en: {
			...
			listEmpty: "لا يوجد احد تم تحزيرو  ",
			listBanEmpty: " لا يوجد شخص محظور محظور من المجموعه  ",
			invalidUid: "أدخل id صالح ",
			noData: "لا توجد اي  معلومات ",
			noPermission: " فقط الأدمن يستطيع الخلص من الحظر  ",
			invalidUid2: "⚠️ أدخل آيدي صحيح كي يتم نزع الحظر  ",
			notBanned: "⚠️ صاحب الآيدي %1 ليس محضورا",
			unbanSuccess: "✅ تم الغاء الحظر عن [%1 | %2], يستطيع الآن دخول المجموعة ✅",
			noPermission2: " فقط أدمن المجموعة يستطيع فعلها ",
			...
			noPermission3: " فقط أدمن المجموعة يستطيع التخلص من  التحذير من الكل",
			resetWarnSuccess: "✅ تم حذف كل البيانات",
			noPermission4: "فقط الأدمن يقدر يحظر",
			invalidUid4: "ضع تاغ أو رد على شخص ",
			warnSuccess: "تحذير العضو %1 المرة %2\n- Uid: %3\n- السبب: %4\n- معلومات كل عدد: %5\nهذا العضو حذر ثلاث مرات وتم حضره من المجموعة,",
			noPermission5: " يجب جعل البوت أدمن ",
			warnSuccess2: "تحذير العضو %1 المرة %2\n- آيديه: %3\n- السبب: %4\n- معلومات كل مرة: %5\nإذا إستمر %6 مرة, سيطرد نهائيا من المجموعة ",
			hasBanned: "هاؤلاء تم تحذيرهم ثلاث مرات و تم حضرهم:\n%1",
			failedKick: " حدثت مشكلة أثناء محاولة طرد العضو:\n%1"
		}
	},
