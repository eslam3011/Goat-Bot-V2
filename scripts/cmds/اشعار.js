...
module.exports = {
	config: {
		...
		longDescription: {
			vi: "Gửi thông báo từ admin đến all box",
			en: "إشعار من أدمن البوت إلى المستخدمين "
		},
		category: "المطور",
		guide: {
			en: "إشعار {نص}"
	...
	langs: {
		...
		en: {
			missingMessage: "من فضلك أدخل رسالة ",
			notification:" =====إشعار=====",
			sendingNotification: "بدأ إرسال إلى %1 مجموعة",
			sentNotification: "✅وصلت رسالتك إلى %1 مجموعة",
			errorSendingNotification: "خطأ عند محاولة إرسال إلى %1 مجموعة:\n%2"
		}
	},
